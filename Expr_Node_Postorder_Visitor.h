#ifndef EXPR_NODE_POSTORDER_VISITOR_H
#define EXPR_NODE_POSTORDER_VISITOR_H
#include"Expr_Node_Visitor.h"

class Expr_Node_Postorder_Visitor : public Expr_Node_Visitor
{
	public:
		Expr_Node_Postorder_Visitor(void);
		~Expr_Node_Postorder_Visitor(void);
